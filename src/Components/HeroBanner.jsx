...
const HeroBanner = () => {
  return (
    <div className='bg-white mt-20 mb-10 px-5'>
      <div className='relative max-w-7xl mx-auto rounded-2xl md:h-[600px] h-[500px] flex justify-center items-center bg-cover bg-center' style={{ backgroundImage: `url(${HeroPexel})`, backgroundPosition: 'top', }}>
